...
public class BigIntCalc {
    ...
    */
    ...
    public String calculation(String number1, String number2) {
        String larger, smaller;

        // Defining which of the two numbers is biggest
        larger = number1.length() > number2.length() ? number1 : number2;
        smaller = number1.length() > number2.length() ? number2: number1;
